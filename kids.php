  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="container mt-5">
        <div class="row">
        <?php $sql = "SELECT * FROM products WHERE ProductID BETWEEN 241 AND 256";
...
<div class="col-md-3">
        <div class="card">
        <a href="#" >
          <img src="assets/photos/kids/<?php echo $row['image'];?>" class="card-img-top img1" alt="Product 1 image">
          </a>
          <div class="card-body">
            ...
            <div class='wrapper text-center'>
              ...
              <?php if($row['Quantity'] <= 0) {?>
                ...
                <input type="hidden" name="image" value="<?php echo 'assets/photos/kids/'.$row['image']?>" />
